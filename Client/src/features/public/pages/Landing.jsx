        ...
        <div className="hero-container">
          ...
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              <span className="gradient-text">Kisan Vikas</span> ΓÇö Direct Farm-to-Buyer Marketplace
            </h1>
              ...
              <div className="flow-step">
                <div className="flow-step-left">
                  ...
                  <div>
                    ...
                    <div className="flow-step-desc">Tomato (Hybrid) ΓÇó 2.5 Tonnes ΓÇó Nashik</div>
                  </div>
                </div>
                <div className="flow-step-value">Γé╣24.5/kg</div>
              </div>
              ...
              <div className="flow-step" style={{ background: '#ecfdf5', borderColor: '#a7f3d0' }}>
                <div className="flow-step-left">
                  ...
                  <div>
                    ...
                    <div className="flow-step-desc">Doorstep delivery ΓÇó Escrow verified</div>
                  </div>
                </div>
